 ...
 * @number: it is the number it will print.
 */
...
/**
 * printerrorex - it prints the error format.
 * @file: iw the execution file.
 * @argv: is the user-given arguments.
 * @count: the execution counter.
 * @message: the error message to print it
 */
